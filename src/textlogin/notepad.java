...
public class notepad extends javax.swing.JFrame {
    ...
    File f = new File("e:\\prueba\\loginBD");
    int ln;
        ...
        try {
            ...
            for(int i=0;i<ln;i+=4){System.out.println("count "+i);
                ...
                if(usr.equals(forUser) & pswd.equals(forPswd)){
                    JOptionPane.showMessageDialog(null, "Entraste La hiciste!!!!");
                    break;
                }else if(i==(ln-3)){
                    JOptionPane.showMessageDialog(null, "NO entras salao!!!!!!!!!!!");
                    break;
                }
    ...
    void countLines(){
        try {
            ...
            System.out.println("total de lineas:"+ln);
        } catch (FileNotFoundException ex) {
            Logger.getLogger(notepad.class.getName()).log(Level.SEVERE, null, ex);
        } catch (IOException ex) {
            Logger.getLogger(notepad.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void initComponents() {
        ...
        jButton4.setText("crear fichero");
        ...
        jLabel1.setText("Prueba de Prueba");

        jLabel2.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jLabel2.setText("Tu Usuariio");

        jLabel3.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jLabel3.setText("Tu contraseña");

        jLabel4.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jLabel4.setText("Tu correo");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(tfusr)
                            .addComponent(tfpswd)
                            .addComponent(tfmail, javax.swing.GroupLayout.PREFERRED_SIZE, 129, javax.swing.GroupLayout.PREFERRED_SIZE))
...
readFile();
countLines();
addData("ponte","20uñas", "pende@jo.com");
...
/*changed aftere video  -->.*/JOptionPane.showMessageDialog(null,"Datos Registrados");        // TODO add your handling code here:
